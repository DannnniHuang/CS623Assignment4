...
INSERT INTO AUTHOR_SUBMIT (AuthorId) SELECT EmailAddr FROM AUTHOR;

#Insert data to Paper
INSERT INTO PAPER (Id, Title, Absrract, FileName) VALUES
((SELECT PaperId FROM AUTHOR_SUBMIT WHERE AuthorId='ChrisE@hotmail.com'),'Thinking in Systems','Thinking in Systems, is a concise offering insight for problem solving on scales ranging from the personal to the global.','FGB,txt'),
((SELECT PaperId FROM AUTHOR_SUBMIT WHERE AuthorId='Scarlett@hotmail.com'),'How Calculus Reveals the Secrets of the Universe','Without calculus, we wouldn’t have cell phones, TV, GPS, or ultrasound. We wouldn’t have unraveled DNA or discovered Neptune or figured out how to put 5,000 songs in your pocket. ','BGF.txt');
